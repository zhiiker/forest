...
impl State {
    ...
    pub fn assign_sectors_to_deadlines<BS: BlockStore>(
        ...
        let deadline_to_sectors = assign_deadlines(partition_size, &deadline_vec, sectors)?;
    ...
    > {
        ...
        let from_vesting = self.unlock_unvested_funds(store, current_epoch, &self.fee_debt)?;
